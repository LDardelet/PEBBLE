...
def GenerateTrackingGif(F, S, SpeedIDs, Folder = '/home/dardelet/Pictures/GIFs/AutoGeneratedTracking', BinDt = 0.005):
...
def PlotPositionTracking(S, SpeedIDs, GroundTruthFile = None, AddSpeedIdLabel = True, AddFeatureIdLabel = True, Tmax = np.inf, legendsize = 20, axissize = 20, titlesize = 20):
    f, axs = plt.subplots(1,2)
    ...
    if AddSpeedIdLabel or AddFeatureIdLabel:
        axs[0].legend(AddToLegend + Labels, fontsize = legendsize)
